...
/**
 * 用来加载类，ClassPath下的资源文件，属性文件等。 getExtendResource(StringrelativePath)方法，可以使用..
 * 符号来加载ClassPath外部的资源。
 */
...
public class ClassLoaderUtil {
	...
	public static void main(String[] args) throws MalformedURLException {
		...
		System.out.println(ClassLoaderUtil.getExtendResource("../tabledescs.xml"));
//		ClassLoaderUtil.getExtendResource("tabledescs.xml");
//		System.out.println(ClassLoaderUtil.getClassLoader().getResource("/src/tabledescs.xml").toString());
	}
